...
void Fruit::display() const{
    ...
    cout << "\t Price:  " << get_price() << " USD" <<endl;
    cout << "\t Unit:  " << show_unit() << endl;
}


Seasoning::Seasoning(std::string name, float price, int inventory):Item(name, price, inventory, Unit::g){}
...
Snack::Snack(std::string name, float price, int inventory):Item(name, price, inventory, Unit::pakage){}
